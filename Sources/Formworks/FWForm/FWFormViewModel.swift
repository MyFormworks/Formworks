                ...
                for component in formData.components {
                    ...
                    case is FWDigitsSpecification:
                        let viewModel = FWSingleLineComponentViewModel(title: component.title,
                                                                       ...
                                                                       required: component.required, validator: FWRegexValidator(defaultValidator: .phonenumber),
                    ...
                    case is FWEmailSpecification:
                        let viewModel = FWSingleLineComponentViewModel(title: component.title,
                                                                       description: component.subtitle ?? "",
                                                                       errorMessage: component.errorMessage ?? "",
                                                                       required: component.required, validator: FWRegexValidator(defaultValidator: .email),
                                                                       componentType: .email)
                        viewModels.append(viewModel)
                    default:
                        let viewModel = FWSingleLineComponentViewModel(title: component.title,
                                                                       description: component.subtitle ?? "",
                                                                       errorMessage: component.errorMessage ?? "",
                                                                       required: component.required, validator: FWRegexValidator(defaultValidator: .max32),
